...
export function rotateCanvas(context, angle, x, y) {
...
export function letterCanvas(width, height) {
...
export function getCharSize(char, fontSize, fontFamily = 'sans-serif', fontWeight = 'normal') {
    const {
        context: ctx
